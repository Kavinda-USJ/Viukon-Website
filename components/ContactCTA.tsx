...
export const ContactCTA: React.FC<ContactProps> = ({ isFullPage = false, contact }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:viukondigitals@gmail.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(formData.message)}`;
  ...
  // Strip all non-digit/+ chars for the tel: href
              ...
              <div className="space-y-6 pt-10">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-white font-bold group-hover:text-brand-yellow transition-colors">{contact.email}</div>
                  </div>
                </a>

                {/* Phone — fully dynamic from admin */}
                <a
                  href={`tel:${phoneTel}`}
                  className="flex items-center gap-4 text-white/60 hover:text-brand-yellow transition-colors group"
                >
                  ...
                  <div>
                    ...
                    <div className="text-white font-bold group-hover:text-brand-yellow transition-colors">{contact.phone}</div>
                  </div>
                </a>

                {/* Address — fully dynamic from admin */}
                ...
                <div className="flex items-center gap-4 pt-6">
                  <a href="https://www.facebook.com/viukon" target="_blank" rel="noopener noreferrer"
                    className="w-12 h-12 rounded-full bg-white/5 hover:bg-white flex items-center justify-center text-brand-yellow hover:text-brand-black transition-all" aria-label="Facebook">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                  </a>
                  <a href="https://www.instagram.com/viukon" target="_blank" rel="noopener noreferrer"
                    className="w-12 h-12 rounded-full bg-white/5 hover:bg-white flex items-center justify-center text-brand-yellow hover:text-brand-black transition-all" aria-label="Instagram">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://www.tiktok.com/@viukon?_r=1&_t=ZS-93Q9bWEuqDh" target="_blank" rel="noopener noreferrer"
                    className="w-12 h-12 rounded-full bg-white/5 hover:bg-white flex items-center justify-center text-brand-yellow hover:text-brand-black transition-all" aria-label="TikTok">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005 20.1a6.34 6.34 0 0010.86-4.43v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1-.1z"/>
                    </svg>
                  </a>
                  <a href="https://www.linkedin.com/company/viukon/" target="_blank" rel="noopener noreferrer"
                    className="w-12 h-12 rounded-full bg-white/5 hover:bg-white flex items-center justify-center text-brand-yellow hover:text-brand-black transition-all" aria-label="LinkedIn">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
